...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "shell", inline: "docker stop $(docker ps -aq) || true; docker rm $(docker ps -aq) || true"
  ...
  config.vm.provision "docker" do |d|
    ...
    d.run 'panoptes', image: "zooniverse/panoptes",
      args: '--link zookeeper:zookeeper --link postgres:postgres -v /home/vagrant/panoptes/config/:/rails_conf/ -e "RAILS_ENV=development" -p 3000:80'
  end
end
